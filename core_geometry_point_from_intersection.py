...
from OCCT.gp import gp_Pln, gp_XOY, gp_Ax3, gp_YOZ, gp_Elips
from OCCT.IntAna import IntAna_IntConicQuad
from OCCT.Precision import precision_Angular, precision_Confusion
